...
# Uniform Sampling
fossilisation.rate <- 0.2 # rate of fossilisation
...
# Biased sampling
low.sampling <- 0.0015 # sampling rate for fossils in low sampling area
high.sampling <- 0.5 # sampling rate for fossils in high sampling area
# Time binning
